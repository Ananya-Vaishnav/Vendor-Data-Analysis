    ...
    PurchaseSummary AS(
        ...
        SalesSummary AS(
            SELECT
                ...
                SUM("SalesQuantity") AS TotalSalesPrice,
...
def clean_data(df):
    ...
    #Remove excess white spaces from categorical columns
...
if __name__ == '__main__':
    ...
    engine = create_engine('postgresql+psycopg2://postgres:Admin%401234@localhost:5432/inventory_db')
